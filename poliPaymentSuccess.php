...
// echo $HTTP_HOST."ajax_autopart.php?action=poliPaymentSuccess&txn_tokken=$txn_tokken&user_id=$user_id&order_id=$order_id&amount=$amount";die;
   $user_paymentSuccess=file_get_contents($HTTP_HOST."ajax_autopart.php?action=poliPaymentSuccess&txn_tokken=$txn_tokken&user_id=$user_id&order_id=$order_id&amount=$amount");

   // print_r($user_paymentSuccess);
