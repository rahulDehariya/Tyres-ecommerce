<?php
   ...
   // $data_Cat = $myCategory->PaymentCancelled(accNum,$_GET); 

    require_once "header.php";

    $txn_tokken=$_GET['AccessCode'];
    $user_id=$_GET['user_id'];
    $order_id=$_GET['order_id'];
    $amount=$_GET['amount'];

    $user_paymentSuccess=file_get_contents($HTTP_HOST."ajax_builder.php?action=PaymentCancelled&txn_tokken=$txn_tokken&customerId=$customerId&user_id=$user_id&order_id=$order_id&amount=$amount");
   ?>
