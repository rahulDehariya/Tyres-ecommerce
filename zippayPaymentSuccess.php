<?php
  ...
  if($result == 'approved'){
    ...
    $ch = curl_init(SERVER_APIURL.'?action=insertZippayResponse&order_id='.$order_id.'&accNum='.accNum);
    ...
    $action = "zipPaymentSuccess";
    $user_paymentSuccess=file_get_contents($HTTP_HOST."ajax_autopart.php?action=zipPaymentSuccess&txn_tokken=$txn_tokken&customerId=$customerId&user_id=$user_id&order_id=$order_id&amount=$amount");

    // print_r($zippay_response);
  ...
  $user_paymentSuccess=file_get_contents($HTTP_HOST."ajax_autopart.php?action=PaymentCancelled&txn_tokken=$txn_tokken&customerId=$customerId&user_id=$user_id&order_id=$order_id&amount=$amount");
 }
                ...
                <div class="products-category">
                   <div class="page-width" data-section-id="cart-template" data-section-type="cart-template">
                      ...
                      <?php } else{ ?>
                        ...
                        <div class="col-md-12">
                        <div class="col-md-6">
                        <a href="zippay.php?order_id=<?php echo $_GET['order_id']; ?>&amount=<?php echo $_GET['amount']; ?>" class="backtostore" style="float: right;">Try Again</a>
                      </div>
                        <div class="col-md-6">
