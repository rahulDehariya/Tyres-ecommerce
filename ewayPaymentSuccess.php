<?php
  ...
  // print_r($_GET);
   ...
   $user_paymentSuccess=file_get_contents($HTTP_HOST."ajax_builder.php?action=poliPaymentSuccess&txn_tokken=$txn_tokken&user_id=$user_id&order_id=$order_id&amount=$amount");
